...
**Power-ups**
1. BonusCoin                ![alt text](bonusCoin.png)

2. DoubleBall               ![alt text](DoubleBall.png)

3. EnLargeBall              ![alt text](ELB.png)          

4. EnLargePaddle            ![alt text](EnlargePaddle.png)

5. ExtraLife                ![alt text](ExtraLife.png)

6. ShootPaddle              ![alt text](ShootPaddle.png)

7. ShrinkPaddle             ![alt text](ShrinkPaddle.png)

8. SlowBall                 ![alt text](SlowBall.png)

9. SpeedBall                ![alt text](SpeedBall.png)
